...
//================================================== Biến tay cầm ==================================================
  ...
  #define DEADZONE 50      // Vùng chết Joystick
  typedef struct {
    uint8_t JOYTRAI[5];
    uint8_t JOYPHAI[5];
  } JOYSTICK_STATE;
...
//================================================== Cấu hình hướng di chuyển đế Robot : tiến/lùi ==================================================
  ...
  struct UartMotorMotionControl {
    ...
    {0,1,1,0}       // Tiến: động cơ 1,4 quay thuận; 2,3 quay ngược
  };
...
//================================================== Điều khiển động cơ BLDC ==================================================
  ...
  uint8_t speed_esc1 = 90; // Tốc độ cho ESC - BLDC
  uint8_t speed_esc2 = 110; // Tốc độ cho ESC - BLDC
