//================================================== ROBOT ==================================================
  ...
  uint8_t ROBOT = 0x01; // Địa chỉ định danh cho robot hiện tại (ví dụ trong hệ thống nhiều robot, mỗi con có một địa chỉ)
...
//================================================== Điều khiển hướng di chuyển của robot ==================================================
  struct UartMotorMotionControl {
    ...
    {1,0,0,1},    // Động cơ 1,4 quay thuận; 2,3 ngược => tiến
    {0,1,1,0}     // Ngược lại => lùi
  };
...
//================================================== Điều khiển động cơ BLDC (ESC) ==================================================
  uint8_t speed_esc1 = 200;   // Tốc độ ESC 1
  uint8_t speed_esc2 = 220;   // Tốc độ ESC 2
